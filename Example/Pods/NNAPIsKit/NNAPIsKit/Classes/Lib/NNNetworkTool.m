...
//POST
+ (void)NNNetworkPOSTGetArrData:(BOOL)isGetArrData URLString:(NSString *)URLString
                     params:(id)params
              pickClassName:(NSString *)pickClassName
                   complete:(void(^)(id netData,id response))complete
                    failure:(void(^)(NSString *error))failure {
    [self networkGetArrData:isGetArrData getMethod:NO URLString:URLString params:params pickClassName:pickClassName complete:complete failure:failure];
...
+ (void)NNNetworkGetArrData:(BOOL)isGetArrData URLString:(NSString *)URLString
              ...
              pickClassName:(NSString *)pickClassName
                   complete:(void(^)(id netData,id response))complete
                    failure:(void(^)(NSString *error))failure {
    [self networkGetArrData:isGetArrData getMethod:YES URLString:URLString params:params pickClassName:pickClassName complete:complete failure:failure];
}


+ (void)networkGetArrData:(BOOL)isGetArrData
                getMethod:(BOOL)getMethod
                  ...
                  failure:(void(^)(NSString *error))failure
{
    ...
    [NNHttpTool GETMethod:getMethod URLString:URLString params:paramsDict success:^(id response) {
        NSLog(@"%@",response);
        @try {
            //safe
